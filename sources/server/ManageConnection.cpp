...
std::vector<std::shared_ptr<fus::net::Connection>> fus::net::ManageConnection::getConnections() const
{
...
std::shared_ptr<fus::net::Connection> fus::net::ManageConnection::getConnection(fus::net::_fd socket) const
{
